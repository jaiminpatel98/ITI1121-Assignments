...
public class GameModel {
    ...
    private boolean status; //false for not captured and true for captured
    ...
    public GameModel(int size) {
        this.size = size; //initializes size of  
    }
